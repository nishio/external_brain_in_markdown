...
- またバイアスの盲点がなくても、古典的な認知バイアスを避けられるわけではない。
...
- <img src='https://scrapbox.io/api/pages/nishio/nishio/icon' alt='nishio.icon' height="19.5"/>結局、ホモサピエンス単体ではどうしようもないじゃん。
    - コンピュータ秘書が隣からそっと「バイアスにハマってますよ」と教えてくれるようにするしかないのではないか？
    - 他のホモサピエンスから「お前間違ってるぞ」って言われると「馬鹿が絡んできた！」と思って間に受けない
        - サルなので仕方がない…
        - [[ホモサピエンスでない知性体]]に指摘される必要がある
    - コンピュータではなくてもホモサピエンスより圧倒的に強い異星人が現れればそれでもいい
        - 要するにホモサピエンスが同じホモサピエンスを見下す傾向があるのが問題なので、違う存在でなければならない
        - [[ホモサピエンスでない方たち]]が必要
