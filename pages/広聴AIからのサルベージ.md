...
- o3は「<img src='https://scrapbox.io/api/pages/nishio/o3-mini-high/icon' alt='o3-mini-high.icon' height="19.5"/>Azureの環境なら、[[Azure Blob Storage]]へのアップロードが唯一現実的です」とかいってくる面倒なシチュエーションを無理やりハックするメモです
