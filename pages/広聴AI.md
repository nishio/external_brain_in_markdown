...
>  Anno-teamは、新しい[[ブロードリスニング]]ツール「kouchou-ai」(kou=broad、chou=聞く)をリリースしました。
>
>  このツールは、AI Objective InstitutesのTalk to the Cityを部分的に利用している一方で、階層的なドリルダウン機能や、オピニオン密度に基づいて密集したオピニオンクラスターを抽出するアルゴリズムなどの新機能が追加されています。
>
>  Dockerを使用して簡単にセットアップできるように設計されており、管理インターフェイスではCSVアップロードと詳細なパラメータ設定が可能なため、エンジニア以外の人でも独立してレポートを生成できます。
