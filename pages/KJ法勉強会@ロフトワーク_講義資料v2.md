...
2026-04-21
> [storywriter](https://x.com/storywriter/status/2045942402238804161) 西尾さん @nishio のロフトワークさんでの「KJ法®︎勉強会」の資料がわかりやすい…！ "探検ネット" の話がきっちりと場に体系的に提示されている… さすがです…。
> [storywriter](https://x.com/storywriter/status/2045945416123138275) そもそもの「探検ネット≒花火」についても、歴史的な変遷を含めてていねいな解説をいただいている… ありがたすぎる… まさにこれ知りたかった… "「知」の探検学" の探検ネットは中央にテーマおいてねーじゃんと悩んでいた…
>  。・゜・(ノД`)・゜・。 [[考える花火誕生の流れ]]
> [nishio](https://x.com/nishio/status/2046032679322497341) ここのところは頑張ってまとめたので講演の後に講演資料が他の人にも役立って喜んでもらえて嬉しいです

> [storywriter](https://x.com/storywriter/status/2045946891729584354) しかし、そうすると某所で今回教わった探検ネットについて… リサーチ前に発想する探検ネットがいわばマインドマップ形状をするのは理解するとして… リサーチ後に集まった情報が中央から広がる網形状に整理できてしまったら、それは変なのでは？ 混沌を表現できてないのでは？
> [storywriter](https://x.com/storywriter/status/2045947260245291271) いや、リサーチの全体感と網羅性の検証ができるのが目的だから、あるていど恣意的でも整理されていないといけないのか…？ 混沌のまま表現してしまったらどこが足りないのかわからないもの…な…？
> [nishio](https://x.com/nishio/status/2046033937915609510) 「[[KJ法 渾沌をして語らしめる]]」(1986) p.257
>  探検後の探検ネット作成プロセスが「中央から周囲に広がる」というプロセスではないことがわかります
>  ![image](https://gyazo.com/e5217f607e76f46209475c6494013184/thumb/1000)
> [nishio](https://x.com/nishio/status/2046045195402367382) 元の質問に戻ると「リサーチの全体感と網羅性の検証」が目的であるとき、それは「探検の前に脳内で考えたもの」を100点として、欠けているところを探すマインドですから、混沌から新しいものを見出そうとするマインドとは方向性が異なります。
>  なので網羅性のチェックが目的であるならKJ法や探検ネットをやる必要はなく単なるチェックリストでも良いです。探検前に作ったものを活用したいならたとえば拡大コピーしてその上に探検で収集した断片の関連しそうなものを並べるとかしても良いです。これをやった場合、置き場所が見つからない断片がいくつも出ることになると思います。
>  川喜田二郎の思考を模倣してみると「事前に脳内で考えた枠組み」よりも「実際に探検して得られた既存の枠組みに入らないデータ」に重きを置いているので、あまり事前の計画を100とする網羅性は気にしないんじゃないかなと思います。これに関連したことを言っているのは「[[探検の五原則]]」の「[[360度の視角から]]」ですが、ここでは「人間の能力には限界があるし、そもそも時間や金の制約で十分な取材ができないことは世の習いである。だができるだけ多様な角度から取材しようとすると雲泥の差になる」という趣旨のことを書いています(前著だとp.218ですが、多分[[「知」の探検学]](1977)にも書かれてるのではないかなと思います。
