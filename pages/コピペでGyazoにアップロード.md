...
- getData
- サーバに送る
- サーバがGyazoの[[OAuth]] APIを叩く [https://gyazo.com/api](https://gyazo.com/api)

そもそもiPadでは
- スクリーンショットを取る
- トリミングする
- Gyazoに送る
- クリップボードに入ったURLを貼り付ける
って手順でやってたのでブラウザからアップロードしてなかった

MacのCmd+Shift+4で選択範囲のキャプチャをした時に便利だが、ユースケースは狭いか
