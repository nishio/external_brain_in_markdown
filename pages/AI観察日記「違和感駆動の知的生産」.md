...
- > 違和感駆動の知的生産は、アイデアの価値を高めるプロセスを指す。知的生産性は最終成果物の価値によるが、その価値が明らかになるまでに[[時間遅れ]]があるため、プロセスの生産性に注目する。アイデアは複製可能なリソースで、既存のアイデアと同じものや自身が熱意を持てないアイデアは価値が低い。アイデアは労力を注ぎ込んで育て上げ、磨き上げることで価値を発揮する。この「良い状態」を生み出し継続することが重要である。
