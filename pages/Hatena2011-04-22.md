...
```
<body>
*1303467581*GitPythonでgitを観察する
とりあえず各種オブジェクトとHEADとbranchesとtagsとindexの変化を観察できることを確認したけど、あと何が必要だろう。
...
[はてなダイアリー 2011-04-22](https://nishiohirokazu.hatenadiary.org/archive/2011/04/22)