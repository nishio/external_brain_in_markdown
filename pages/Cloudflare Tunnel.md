...
2026-05-09
- Claude Codeにおすすめされたので任せたが、CloudflareでNS管理しているドメインが必要だった
    - > <img src='https://scrapbox.io/api/pages/nishio/Claude/icon' alt='Claude.icon' height="19.5"/>ドメイン不要・iPhone 1分で繋がる [[Tailscale]] で進めるのを推奨します（auth = 自分のデバイスである、という形になる）
        - まあ一人で使うサービスならそれでいいか
