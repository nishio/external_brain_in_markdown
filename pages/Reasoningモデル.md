...
- 例えば、OpenAIが2024年9月に発表した「[[o1]]」モデルや、同年12月の「[[o3]]」モデルは、数学、科学、プログラミングなどの分野で従来のLLMよりも高い性能を示しています。 ​また、2025年1月には中国のDeepSeek社が「[[DeepSeek-R1]]」という6710億パラメータの推論モデルを公開し、OpenAIの「o1」と同等の性能を達成しています。 ​
